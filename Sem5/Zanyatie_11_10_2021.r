...
lines(x.qq$x,x.env$point[1, ], lty = 4, col = "blue")
lines(x.qq$x,x.env$point[2, ], lty = 4, col = "blue")
lines(x.qq$x,x.env$overall[1, ], lty = 1, col = "green")
lines(x.qq$x,x.env$overall[2, ], lty = 1, col = "green")
